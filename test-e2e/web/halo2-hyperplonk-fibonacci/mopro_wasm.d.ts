 ...
 * @returns {any}
 */
export function verify_proof(srs_key: Uint8Array, verifying_key: Uint8Array, proof: Uint8Array, public_inputs: Uint8Array): any;

export type InitInput = RequestInfo | URL | Response | BufferSource | WebAssembly.Module;

export interface InitOutput {
  readonly generate_proof: (a: number, b: number, c: number, d: number, e: number, f: number) => void;
  readonly verify_proof: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number) => void;
