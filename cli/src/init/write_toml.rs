...
[dependencies]
mopro-ffi = { git = "https://github.com/zkmopro/mopro.git", branch="mopro-wasm-refactor"}
thiserror = "2.0.12"
anyhow = "1.0.99"
...
[dev-dependencies]
mopro-ffi = { git = "https://github.com/zkmopro/mopro.git", branch="mopro-wasm-refactor", features = ["uniffi-tests"] }
...
mopro-ffi = { git = "https://github.com/zkmopro/mopro.git", branch="mopro-wasm-refactor", features = ["wasm"] }
