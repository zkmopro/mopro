...
This tutorial will show you how to build static library with Circom adapter for Android and iOS. Later pages show how to
integrate into an
existing iOS or Android app.
...
or `cargo run --bin android` to build the corresponding static library. Move on to [iOS setup](ios-setup)
or [Android setup](android-setup) to begin integrating in an app.
