...
fn bucket_wise_msm<V: VariableBaseMSM>(
    ...
    // TODO: traverse once and find the indices which can apply precomputation
    // e.g. (bucket_idx, point_idx)
    // (1, 2), (1, 2), (1, 2), (1, 2)
    // -> (1, idx_to_get_precomp_point_of_4 * p[2])
    ...
    I: Iterator<Item = preprocess::Instance>,
{
    ...
    for instance in instances {
        ...
        for _i in 0..iterations {
            ...
            // let _result = msm_bigint::<G>(&points[..], &scalars[..]);
